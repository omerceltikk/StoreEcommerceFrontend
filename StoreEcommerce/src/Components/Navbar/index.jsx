                                                            ...
                                                            {categories.map((category, i) => (
                                                                <li className={` customLink my-3`} key={i}>
                                                                    ...
                                                                    <div className={`row`}>
                                                                        {
                                                                            data2.categories.filter((item) => item.categoryGender == category).map((filteredItem) => (
                                                                                <div key={filteredItem.id}><Link to={`/categories/${filteredItem.id}`} className="customLink text-secondary mt-2 mx-4" data-bs-dismiss="offcanvas" aria-label="Close" href="#">{filteredItem.category}</Link></div>
                                                                            ))
                                                                        }
                                                                    </div>
                                                                </li>
